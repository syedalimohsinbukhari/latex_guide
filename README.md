...
samples and datasets referenced from the chapters. See [`00_index.md`](00_index.md)
for the full table of contents with links to every chapter and section.

| Part | Chapters | File |
|---|---|---|
| 1 — Foundations & Capstone Kickoff | 1–4 | `ch01-04_foundations.md` |
| 2 — Core Typesetting | 5–8 | `ch05-08_core_typesetting.md` |
| 3 — Math Mechanics | 9–10 | `ch09-10_math_mechanics.md` |
| 4 — Math Structures & Algorithms | 11–12 | `ch11-12_math_structures.md` |
| 5 — Bibliography & Citation Tools | 13–16 | `ch13-16_bibliography.md` |
| 6 — Diagrams & Data Visualization | 17–18 | `ch17-18_diagrams_data.md` |
| 7 — Macros & Templates | 19–20 | `ch19-20_macros_templates.md` |
| 8 — Collaboration & Diagnostics | 21–22 | `ch21-22_collaboration_diagnostics.md` |
| 9 — Capstone Assembly | 23 | `ch23_capstone_assembly.md` |

Plus `appendix.md` (cheat sheets and reference tables) and
`supplementary_materials.md` (larger worked examples and starter datasets,
including `ch18_sample_data.csv`).
...
This reads every chapter file directly from this folder, assembles them via
